...
# ============================================================
# P3O-CBF 步态微调训练脚本
# 在已有模型基础上优化步态质量，保持障碍物避障能力
# 基础模型: P3O-END2END-001/2026-04-30_06-06-44/model_final.pt
# GPU: RTX 5090 (32GB)
# ============================================================
...
conda run -n ${CONDA_ENV} python \
    ${PROJECT_DIR}/unitree_rl_lab/scripts/rsl_rl/paper_2508_07611/finetune_end2end_gait.py \
    --headless \
    --device cuda:0 \
    --resume ${CHECKPOINT} \
    --num_envs ${NUM_ENVS} \
